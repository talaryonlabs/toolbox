...
public static class StringExtensions
{
    extension(string p)
    {
        ...
        public string FromBase64String()
        {
            var bytes = Convert.FromBase64String(p);
            return Encoding.UTF8.GetString(bytes);
        }

        public string SlugifyString(int maxLength = 0)
        {
        ...
        public string ReplaceMany(IEnumerable<KeyValuePair<string,string>> replacements)
        {
